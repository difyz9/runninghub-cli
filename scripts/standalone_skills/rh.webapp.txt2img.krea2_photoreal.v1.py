#!/usr/bin/env python3
"""Auto-generated standalone script from rh.webapp.txt2img.krea2_photoreal.v1.json.

Skill: rh.webapp.txt2img.krea2_photoreal.v1
Description: Krea2 photorealistic 4K text-to-image webapp. Uses a single prompt to generate a high-resolution realistic image.

Dependencies:
  pip install runninghub-sdk

Usage example:
  python rh.webapp.txt2img.krea2_photoreal.v1.py --prompt_text 'prompt_text_value'
"""
...
SKILL_NAME = 'rh.webapp.txt2img.krea2_photoreal.v1'
RESOURCE_ID = '2082295063975120897'
RESOURCE_TYPE = 'webapp'
MAPPING = [{'param': 'prompt_text', 'nodeId': '64', 'fieldName': 'text', 'valueMode': 'literal'}]
DEFAULT_INSTANCE_TYPE = 'default'
DEFAULT_TIMEOUT = 1800
DEFAULT_POLL_INTERVAL = 15
DEFAULT_OUTPUT_SUBDIR = 'rh.webapp.txt2img.krea2_photoreal.v1_outputs'
INPUTS = {'required': [{'name': 'prompt_text', 'type': 'string', 'description': 'Primary photorealistic generation prompt'}], 'optional': []}
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog='rh-rh.webapp.txt2img.krea2_photoreal.v1', description='Krea2 photorealistic 4K text-to-image webapp. Uses a single prompt to generate a high-resolution realistic image.')
    ...
    p.add_argument('--prompt_text', required=True, help='Primary photorealistic generation prompt')
    return p
