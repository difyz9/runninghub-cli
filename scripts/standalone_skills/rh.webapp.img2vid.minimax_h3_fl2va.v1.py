#!/usr/bin/env python3
"""Auto-generated standalone script from rh.webapp.img2vid.minimax_h3_fl2va.v1.json.

Skill: rh.webapp.img2vid.minimax_h3_fl2va.v1
Description: MiniMax H3 FL2VA image-to-video webapp. Uses one reference image and a prompt to generate a short video.

Dependencies:
  pip install runninghub-sdk

Usage example:
  python rh.webapp.img2vid.minimax_h3_fl2va.v1.py --reference_image_path /path/to/reference_image_path
"""
...
SKILL_NAME = 'rh.webapp.img2vid.minimax_h3_fl2va.v1'
RESOURCE_ID = '2084535715072929793'
...
DEFAULT_OUTPUT_SUBDIR = 'rh.webapp.img2vid.minimax_h3_fl2va.v1_outputs'
INPUTS = {'required': [{'name': 'reference_image_path', 'type': 'image', 'description': 'Local input image path'}], 'optional': [{'name': 'prompt_text', 'type': 'string', 'default': '保持人物主体一致，生成6秒轻微动作视频，镜头平稳推进，光线自然，画面清晰。', 'description': 'Prompt describing motion and style'}]}
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog='rh-rh.webapp.img2vid.minimax_h3_fl2va.v1', description='MiniMax H3 FL2VA image-to-video webapp. Uses one reference image and a prompt to generate a short video.')
    ...
    p.add_argument('--prompt_text', default='保持人物主体一致，生成6秒轻微动作视频，镜头平稳推进，光线自然，画面清晰。', help='Prompt describing motion and style')
    return p
