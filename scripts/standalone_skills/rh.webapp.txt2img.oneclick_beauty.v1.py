#!/usr/bin/env python3
"""Auto-generated standalone script from rh.webapp.txt2img.oneclick_beauty.v1.json.

Skill: rh.webapp.txt2img.oneclick_beauty.v1
Description: One-click beauty image generation webapp. Uses a single prompt to generate a beautified portrait-style image.

Dependencies:
  pip install runninghub-sdk

Usage example:
  python rh.webapp.txt2img.oneclick_beauty.v1.py --prompt_text 'prompt_text_value'
"""
...
SKILL_NAME = 'rh.webapp.txt2img.oneclick_beauty.v1'
RESOURCE_ID = '2060288081298804738'
RESOURCE_TYPE = 'webapp'
MAPPING = [{'param': 'prompt_text', 'nodeId': '23', 'fieldName': 'prompt', 'valueMode': 'literal'}]
DEFAULT_INSTANCE_TYPE = 'default'
DEFAULT_TIMEOUT = 1800
DEFAULT_POLL_INTERVAL = 15
DEFAULT_OUTPUT_SUBDIR = 'rh.webapp.txt2img.oneclick_beauty.v1_outputs'
INPUTS = {'required': [{'name': 'prompt_text', 'type': 'string', 'description': 'Primary image generation prompt'}], 'optional': []}
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog='rh-rh.webapp.txt2img.oneclick_beauty.v1', description='One-click beauty image generation webapp. Uses a single prompt to generate a beautified portrait-style image.')
    ...
    p.add_argument('--prompt_text', required=True, help='Primary image generation prompt')
    return p
